...
public class InsertResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            ResultSet rs=stmt.executeQuery("select * from students where roll='"+roll+"'");
            
            if(rs.next()) {
                stmt.executeUpdate("insert into result(roll, physics, chemistry, mathematics, english, electrical)  values('"+roll+"','"+physics+"','"+chemistry+"','"+mathematics+"','"+english+"','"+electrical+"')");
                JOptionPane.showMessageDialog(null,"Result is submitted successfully");
                setVisible(false);
                new InsertResult().setVisible(true);
            } else {
